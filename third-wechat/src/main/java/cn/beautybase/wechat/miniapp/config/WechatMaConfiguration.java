...
public class WechatMaConfiguration {
    ...
    public WxMaConfig config(WechatMiniappAccessTokenService wechatMiniappAccessTokenService) {
        WxMaInMemoryConfig config = new WechatMaCacheConfiguration(wechatMiniappAccessTokenService);
